...
@section('content')
    ...
    <section class="content-section site-section reveal">
        <div class="site-grid">
            <div class="site-left">
                <img src="{{ asset('assets/imgs/websites/paradise/paradise_logo.png') }}" alt="Paradise" class="site-logo">
            ...
            <div class="site-right">
                <img src="{{ asset('assets/imgs/websites/paradise/paradise_minis1.jpg') }}" alt="Paradise preview 1" class="site-mini site-mini-1">
                <img src="{{ asset('assets/imgs/websites/paradise/paradise_minis2.jpg') }}" alt="Paradise preview 2" class="site-mini site-mini-2">
                <img src="{{ asset('assets/imgs/websites/paradise/paradise_minis3.jpg') }}" alt="Paradise preview 3" class="site-mini site-mini-3">
            </div>
        </div>
    </section>
    ...
    <section class="content-section site-section reveal">
        <div class="site-grid">
            <div class="site-left">
                <img src="{{ asset('assets/imgs/websites/palesso/palesso_logo.png') }}" alt="Palesso" class="site-logo">
            ...
            <div class="site-right">
                <img src="{{ asset('assets/imgs/websites/palesso/palesso_minis1.jpg') }}" alt="Palesso preview 1" class="site-mini site-mini-1">
                <img src="{{ asset('assets/imgs/websites/palesso/palesso_minis2.jpg') }}" alt="Palesso preview 2" class="site-mini site-mini-2">
                <img src="{{ asset('assets/imgs/websites/palesso/palesso_minis3.jpg') }}" alt="Palesso preview 3" class="site-mini site-mini-3">
            </div>
        </div>
    </section>
    ...
    <section class="content-section site-section reveal">
        <div class="site-grid">
            <div class="site-left">
                <img src="{{ asset('assets/imgs/websites/kepszakadas/kepszakadas_logo.png') }}" alt="Képszakadás" class="site-logo">
            ...
            <div class="site-right">
                <img src="{{ asset('assets/imgs/websites/kepszakadas/kepszakadas_minis1.jpg') }}" alt="Képszakadás preview 1" class="site-mini site-mini-1">
                <img src="{{ asset('assets/imgs/websites/kepszakadas/kepszakadas_minis2.jpg') }}" alt="Képszakadás preview 2" class="site-mini site-mini-2">
                <img src="{{ asset('assets/imgs/websites/kepszakadas/kepszakadas_minis3.jpg') }}" alt="Képszakadás preview 3" class="site-mini site-mini-3">
            </div>
        </div>
    </section>
    ...
    <section class="content-section site-section reveal">
        <div class="site-grid">
            <div class="site-left">
                <img src="{{ asset('assets/imgs/websites/juiced/juiced_logo.png') }}" alt="Juiced" class="site-logo site-logo-invert">
            ...
            <div class="site-right">
                <img src="{{ asset('assets/imgs/websites/juiced/juiced_minis1.jpg') }}" alt="Juiced preview 1" class="site-mini site-mini-1">
                <img src="{{ asset('assets/imgs/websites/juiced/juiced_minis2.jpg') }}" alt="Juiced preview 2" class="site-mini site-mini-2">
                <img src="{{ asset('assets/imgs/websites/juiced/juiced_minis3.jpg') }}" alt="Juiced preview 3" class="site-mini site-mini-3">
            </div>
        </div>
    </section>
