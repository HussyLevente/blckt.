...
@section('content')
    ...
    <div class="manifesto-pin">
        <section class="manifesto-section">
            <div class="manifesto-content">
                <h2 class="manifesto-text">We build your future so you don&rsquo;t have to.</h2>
    ...
    <section class="content-section websites-section reveal">
        <div class="text-and-logos">
            <div class="text-content">
                <p>We are not only designing your websites but actually make them with precision and functionality.</p>
                <p style="margin-top:150px">Here is the most recent one we did.</p>
            </div>
        ...
        <div class="slider-container">
            ...
            <div class="slider-wrapper">
                ...
                <div class="slider-viewport">
                    <div class="slider-items">
                        ...
                        <div class="slider-item placeholder"><span>Coming soon</span></div>
                        <div class="slider-item placeholder"><span>Coming soon</span></div>
                        <div class="slider-item placeholder"><span>Coming soon</span></div>
                    </div>
                </div>
            ...
            <div class="center-button">
                <a href="#" class="btn-pill">all websites</a>
            </div>
        </div>
    </section>
    ...
    <div class="manifesto-pin">
        <section class="manifesto-section">
            <div class="manifesto-content">
                <h2 class="manifesto-text">Do you like aesthetic colors and patterns?</h2>
                <span class="manifesto-brand">Of course you do.</span>
            </div>
        </section>
    </div>
    ...
    <section class="content-section clothing-section reveal">
        <div class="text-and-logos">
            <div class="text-content">
                <p class="mt-4">That's why we make high quality clothes that function for long time. No matter your everywhere clothing.</p>
                <p class="mt-4">Here are some of the recommend. Click "all clothing" to see more.</p>
            </div>
        ...
        <div class="slider-container">
            <h3 class="slider-title">blckt. collection <span class="arrow-icon">▶</span></h3>
            <div class="slider-wrapper">
                <button class="slider-btn prev-btn"><img src="{{ asset('assets/imgs/slider_arrow_blckt.png') }}" alt="Prev"></button>
                <div class="slider-viewport">
                    <div class="slider-items">
                        <div class="slider-item"><img src="{{ asset('assets/imgs/blckt_coll_promo3d_agapiti1.png') }}" alt="Agapiti 1"></div>
                        <div class="slider-item"><img src="{{ asset('assets/imgs/blckt_coll_promo3d_agapiti2.png') }}" alt="Agapiti 2"></div>
                        <div class="slider-item"><img src="{{ asset('assets/imgs/blckt_coll_promo3d_agapiti3.png') }}" alt="Agapiti 3"></div>
                        <div class="slider-item placeholder"><span>Coming soon</span></div>
                        <div class="slider-item placeholder"><span>Coming soon</span></div>
                        <div class="slider-item placeholder"><span>Coming soon</span></div>
                    </div>
            ...
            <div class="center-button">
                <a href="#" class="btn-pill">all clothing</a>
            </div>
        </div>
    </section>
@endsection
